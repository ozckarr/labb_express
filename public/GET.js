...
function listPotatoes(){
    ...
    .then((response) => { return response.json()
        ...
        potatoes.forEach(potato => {
            let potatoDiv = potatoLayout(potato);
...
function printFoundPotato(potato){
    ...
    if (potato) {
        let potatoDiv = foundPotatoLayout(potato)
...
function foundPotatoLayout(potato){
    ...
    potatoRemoveButton.setAttribute("onClick", `removePotato(${potato.id})`)
    let potatoChangeButton = document.createElement("button")
    potatoChangeButton.innerHTML = "Uppdatera"
    potatoChangeButton.setAttribute("onClick", `updatePotato(${potato.id})`)
